...
use App\User\Infrastructure\Symfony\Security\Model\User as SymfonyUser;
use Symfony\Bundle\SecurityBundle\Security;

final readonly class GetUserAuthenticated implements GetUserAuthenticatedInterface
{
