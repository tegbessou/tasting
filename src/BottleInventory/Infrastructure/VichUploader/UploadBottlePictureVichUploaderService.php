...
final readonly class UploadBottlePictureVichUploaderService implements UploadBottlePictureServiceInterface
{
    ...
    public function upload(
        ...
        try {
            $file = new UploadedFile($picturePath, $pictureOriginalName);
