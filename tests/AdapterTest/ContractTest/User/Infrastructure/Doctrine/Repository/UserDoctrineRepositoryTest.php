...
use App\User\Infrastructure\Doctrine\Repository\UserDoctrineRepository;
use Doctrine\ORM\EntityManagerInterface;
use Symfony\Bundle\FrameworkBundle\Test\KernelTestCase;

final class UserDoctrineRepositoryTest extends KernelTestCase
{
    private UserDoctrineRepository $doctrineUserRepository;
    ...
    protected function setUp(): void
    {
        ...
        $this->doctrineUserRepository = $container->get(UserDoctrineRepository::class);
    }
